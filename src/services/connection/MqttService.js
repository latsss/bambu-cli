...
// Bambu's self-signed CA. Inlined (vs reading from disk) so this works inside a
// Node SEA single-file binary without needing to ship the .pem separately.
// Only used when BAMBU_STRICT_TLS=1 — by default we don't verify.
